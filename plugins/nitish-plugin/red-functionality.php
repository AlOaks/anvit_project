<?php
 /**
 *
 * @package   Nitish Funcionality
 * @author    Alberto Robles <jalberto.robles@outlook.com>
 * @license   GPL-2.0+
 * @copyright 2018 Nitish
 *
 * @wordpress-plugin
 * Plugin Name: Nitish Functionality
 * Description: DO NOT DEACTIVATE IT! This very important plugin contains all of the core functionality for this website so that it remains theme-independent. 
 * Version:     1.0.0
